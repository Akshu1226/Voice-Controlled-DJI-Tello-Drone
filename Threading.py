...
# Create threads for recognizing command and listening for input
def start_threads():
    recognition_thread = threading.Thread(target=listen_and_execute)
    recognition_thread.daemon = True  # Allow the thread to close when the main program ends
